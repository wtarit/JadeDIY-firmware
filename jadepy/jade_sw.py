...
#
# Use via JadeInterface.create_software() (see JadeInterface)
#
class JadeSWImpl:
    ...
    def write(self, bytes_):
        ...
        assert self.libjade.libjade_send(bytes_, len(bytes_))
        return len(bytes_)  # Let the caller know we wrote all bytes
