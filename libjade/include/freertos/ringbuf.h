#ifndef _SW_JADE_FREERTOS_RINGBUF_H_
#define _SW_JADE_FREERTOS_RINGBUF_H_ 1
...
typedef struct Ringbuffer {
    struct wally_map m;
    pthread_mutex_t mutex; // FIXME: We could use a semaphore to wake readers
} * RingbufHandle_t;
...
#endif // _SW_JADE_FREERTOS_RINGBUF_H_
